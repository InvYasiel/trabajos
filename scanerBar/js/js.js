...
function rellenar(dato) {
    ...
    TipoAF.innerHTML = dato.TIPONOMBRE;
...
contPuesto.style = 'display:none';
    ...
    if (dato.LETRAEAN != 'L' && dato.LETRAEAN != 'H' && dato.LETRAEAN != undefined) {
btn_guardar.setAttribute('onclick', 'guardar()')
contPuesto.innerHTML = '';
...
function guardar() {
if(selPadre.textContent == 'Asignarle puesto'){
    selPadre.textContent = '';
}
    var infoParaEnviar = {
        Activofijo: m,
